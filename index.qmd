...
Download the Quarto document from [this link](https://github.com/Sanduni-P/IntroR-Viz/blob/main/utils/Notebook.qmd). Click the download raw file button at the right side. Open it using the RStudio. We will use it as a notebook during this workshop. 
